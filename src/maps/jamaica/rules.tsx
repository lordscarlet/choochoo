    ...
    <div>
      ...
      <ul>
        ...
        <li>
          ...
          If the first player cannot or does not want to pay, then the other player
          can pay $5 to go first instead. If the other player chooses not to, then the
          first player can go first for free.
        </li>
        <li>
          <b>Game lasts:</b> until there are no goods left on Jamaica. Goods on
          the growth chart don&apos;t count.
        </li>
        <li>
