import { getRowList, IncomeVps, RowFactory, SharesVps, TotalVps, TrackVps } from "../../client/game/final_overview_row";
import { MapSettings, ReleaseStage } from "../../engine/game/map_settings";
import { Action } from "../../engine/state/action";
import { insertBefore } from "../../utils/functions";
import { interCityConnections } from "../factory";
import { getActionCaption } from "./action_caption";
import { DetroitAllowedActions, DetroitSelectAction, DetroitSelectActionPhase } from "./actions";
...
export class DetroitBankruptcyMapSettings implements MapSettings {
  ...
  getFinalOverviewRows(): RowFactory[] {
    ...
    return insertBefore(rowList, TotalVps, RoundsLasted)
