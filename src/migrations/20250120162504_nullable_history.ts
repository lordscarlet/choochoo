...
export const up: Migration = async ({ context: queryInterface }) => {
  ...
  await queryInterface.changeColumn('GameHistories', 'actionData', { type: DataTypes.TEXT, allowNull: true });
...
export const down: Migration = async ({ context: queryInterface }) => {
  ...
  await queryInterface.changeColumn('GameHistories', 'actionData', { type: DataTypes.TEXT, allowNull: false });
